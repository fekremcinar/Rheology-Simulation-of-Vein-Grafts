...
Option B — ParaView Python Shell (Tools → Python Shell):
    ...
    sys.argv = [
        '',
        '--case',   '/Users/you/Rheology-Simulation-of-Vein-Grafts/run/01_simple_laminar',
        '--radius', '0.005',
    ]
    exec(open('/Users/you/Rheology-Simulation-of-Vein-Grafts/assets/paraview/standard_viz.py').read())
...
try:
    ...
    pass  # keep defaults if argparse unavailable (e.g. inside ParaView GUI)
...
streamTracer = StreamTracer(Input=reader, SeedType='High Resolution Line Source')
