...
==============================================================
Pipeline for experiment 03_heartbeat_sinusoidal_with_initial_velocity (pulsatile Poiseuille flow):
...
CASE_DIR = os.path.expanduser(
    "~/Rheology-Simulation-of-Vein-Grafts/run/03_heartbeat_sinusoidal_with_initial_velocity"
)
